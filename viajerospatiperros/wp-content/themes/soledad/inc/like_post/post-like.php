...
function penci_getPostLikeLink( $post_id ) {
	...
	$return = '<a class="penci-post-like' . $class . '" data-post_id="' . $post_id . '" title="' . $title . '" data-like="' . esc_html__( 'Like', 'soledad' ) . '" data-unlike="' . esc_html__( 'Unlike', 'soledad' ) . '">' . penci_icon_by_ver('far fa-heart') . '<span class="dt-share">'. sanitize_text_field( $like_count ) .'</span></a>';
...
function penci_single_getPostLikeLink( $post_id ) {
	...
	$return = '<span class="count-number-like">'. sanitize_text_field( $like_count ) .'</span><a class="penci-post-like single-like-button' . $class . '" data-post_id="' . $post_id . '" title="' . $title . '" data-like="' . esc_html__( 'Like', 'soledad' ) . '" data-unlike="' . esc_html__( 'Unlike', 'soledad' ) . '">' . penci_icon_by_ver('far fa-heart') . '</a>';
