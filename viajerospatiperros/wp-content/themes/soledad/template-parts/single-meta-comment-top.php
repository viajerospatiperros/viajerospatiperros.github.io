...
<?php if( ! get_theme_mod( 'penci_single_meta_comment' ) || ! get_theme_mod( 'penci_post_share' ) ): ?>
	<div class="tags-share-box tags-share-box-top<?php echo esc_attr( 's1' == $style_cscount ? ' center-box' : ' tags-share-box-2_3' ); ?> tags-share-box-<?php echo esc_attr( $style_cscount ); ?>">
		<?php
		if( 's1' != $style_cscount ){
