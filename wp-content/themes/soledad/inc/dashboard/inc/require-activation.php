				...
				<div class="penci-activate-wrap gt-tab-pane gt-is-active">
					<div class="penci-activate-envato-code">
						...
						<p class="penci-activate-desc">
							...
							<br>
							<?php echo __( 'And please note that: With each license - you just can use for one website.<br>If you want to use this theme for multiple sites, please buy more licenses for it.<br>Example: 2 licenses can use for 2 websites, 4 licenses can use for 4 websites, 7 licenses can use for 7 websites,...','soledad' ); ?>
						</p>
						<form id="penci-check-license" action="<?php echo admin_url( 'admin.php?page=soledad_active_theme' ); ?>">
							<div class="penci-activate-inputs">
								<input name="evato-code" class="penci-form-control evato-code" type="text" placeholder="<?php esc_html_e( 'Your Envato Token', 'soledad' ); ?>" value="">
								...
								<div class="penci-activate-err">
									...
									<span class="penci-err-nottoken"><?php esc_html_e( 'Registration could not be completed because the value entered above is a purchase code. A Envato Token key is needed to register. Please check the guide below for more.', 'soledad' ); ?></span>
									<span class="penci-err-invalid"><?php esc_html_e( 'Invalid token, or corresponding this Envato account does not purchased Soledad.', 'soledad' ); ?></span>
							...
							<div class="soledad-find-code">
								<a href="<?php echo esc_url( 'https://build.envato.com/create-token/?user:username=t&purchase:download=t&purchase:verify=t&purchase:list=t' ); ?>" target="_blank">
									<?php esc_html_e( 'Find your Envato token', 'soledad' ); ?>
								</a>
							</div>
						</form>
